    ...
    <div className="p-12 py-8 px-10 mt-24">
      ...
      <form onSubmit={handleSearch} className="grid grid-cols-5 gap-4 mb-8">
        ...
        <div className="col-span-5 flex justify-center items-center">
          <button
            type="submit"
            className="bg-black rounded-full text-white border border-white px-4 py-2 rounded hover:bg-transparent hover:text-black hover:border-black transition-colors duration-300 w-full"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
        {properties.length > 0 ? (
          properties.map((property) => (
            <div key={property._id} className="p-4 border rounded shadow-md transition-transform duration-300 hover:shadow-lg">
