        ...
        <>
          ...
          <div className="flex bg-white justify-between mt-5 px-5 gap-6 mb-16">
            ...
            <div className="bg-white p-6 w-2/5 ml-44">
              ...
              <h2 className="text-2xl text-[#001f3f] font-serif mb-4">Property Summary</h2>
              <h2 className="text-lg text-[#001f3f] font-serif mt-10 mb-4">{property.detail}</h2>
              <p className="text-base text-gray-700 mt-4">{property.summary}</p>
            </div>

            {/* Right Section */}
            <div className="bg-white p-6 w-2/5 ml-12">
              <h2 className="text-2xl text-[#001f3f] font-serif mb-4">Property Details</h2>
              <div className="grid grid-cols-2 gap-4">
