...
export default function Footer() {
  ...
  return (
    <main className="font-serif text-black">      
      ...
      <div className="flex justify-center items-end gap-8 mb-6">
        <div className="flex flex-col text-left">
          ...
          <input
            ...
            className="p-2 w-64 border-b border-white bg-black text-white placeholder-gray-400 focus:outline-none"
          />
        </div>
        <div className="flex flex-col text-left">
        ...
        <div className="flex items-center">
          <button
            ...
            className="py-2 px-8 border border-white rounded-full hover:border-red-500 transition-colors duration-300"
          >
            Sign up
          </button>
          {showMessage && (
            <span className="ml-4 text-green-500 text-sm">Thanks for signing up!</span>
          )}
        </div>
      </div>
      ...
      {/* Footer Information */}
      <div className="flex justify-evenly text-lg font-serif bg-black p-10 text-white">
        <div>
          <div className="flex items-center">
            <Link href="/">
              <div className="flex items-center cursor-pointer">
                <img src="/logo.png" alt="Logo" className="w-12 h-12 mr-4" />
                <p className="font-bold text-4xl bg-clip-text text-white">
                  Property Pros
                </p>
              </div>
            </Link>
