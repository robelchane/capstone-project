...
const About = () => {
  return (
    ...
    >
        <h1 className="mt-56 text-4xl font-bold mb-10">About Us</h1>
        ...
        <div className="left-0 right-0 grid grid-cols-1 lg:grid-cols-6 w-full mb-48">      
          {/* Box 1 */}
          <div className="cursor-pointer p-8 bg-[#AE905E] text-white transition duration-300 hover:bg-[#A98B59]">
          ...
          {/* Box 2 */}
          <div className="cursor-pointer p-8 bg-[#A98B59] text-white transition duration-300 hover:bg-[#A48654]">
          ...
          {/* Box 3 */}
          <div className="cursor-pointer p-8 bg-[#A48654] text-white transition duration-300 hover:bg-[#9F814F]">
          ...
          {/* Box 4 */}
          <div className="cursor-pointer p-8 bg-[#9F814F] text-white transition duration-300 hover:bg-[#957745]">
          ...
          {/* Box 5 */}
          <div className="cursor-pointer p-8 bg-[#957745] text-white transition duration-300 hover:bg-[#906D3B]">
        ...
        <h1 className="text-4xl font-bold mb-10">What We Offer</h1>
        <div className="grid grid-cols-1 gap-6 w-full">
          ...
          <div className="flex flex-col md:flex-row items-stretch">
            ...
            <div className="md:w-1/2 w-full h-full text-white bg-black opacity-80 flex flex-col justify-center p-10">
              <h1 className="text-3xl mb-10">I am a good fit for...</h1>
              ...
              <div className="flex gap-4 mt-10">
                <Link href="/seller">
                  <button className="mr-5 rounded px-10 py-4 bg-yellow-700 text-white text-lg font-semibold hover:bg-yellow-800 hover:scale-105 transition-transform duration-300">
                    Seller Form
                  </button>
                </Link>
                <Link href="/contact">
                  <button className="px-10 py-4 rounded bg-yellow-700 text-white text-lg font-semibold hover:bg-yellow-800 hover:scale-105 transition-transform duration-300">
                    Get In Touch
                  </button>
                </Link>
              </div>
        ...
        <div className="grid grid-cols-1 gap-6 w-full">
          ...
          <div className="flex flex-col md:flex-row items-stretch">
            <div className="md:w-1/2 w-full h-full text-white bg-black opacity-80 flex flex-col justify-center p-10">
              <h1 className="text-3xl mb-10">I am a good fit for...</h1>
              <h1 className="text-4xl font-bold">Buying</h1>
              <p className="mt-48 text-xl">
        ...
        <h1 className="text-4xl font-bold mt-48 mb-10">Meet The Team</h1>
        ...
        <Link href="/" className=" mb-24 bg-yellow-700 text-white text-xl px-10 py-4 rounded hover:bg-yellow-800 transition duration-300">
          Back to Home
        </Link>
      </div>
  );
